...
class ModalViewController : UIViewController {
    ...
    func makeCellData() -> CellData{
        ...
        else { return CellData.init(columnId: 0, cardId: 0, title: "", content: "", isApp: false, createdTime: "", position: 0) }
        
        let cellData : CellData = CellData.init(columnId: 0, cardId: 0, title: titlefieldText, content: contentFieldText, isApp: false, createdTime: "", position: 0)
        return cellData
    }
}
