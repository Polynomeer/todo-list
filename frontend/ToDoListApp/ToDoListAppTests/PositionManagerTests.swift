...
class PositionManagerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        cellDataArray = .init(arrayLiteral: CellData(columnId: 0, cardId: 0, title: "title0", content: "content0", isApp: true, createdTime: "2021-04-12 15:52:??", position: 0))
    }
    ...
    func test_relocate() {
        ...
        let comparisonTarget : [CellData] = .init(arrayLiteral: CellData(columnId: 0, cardId: 0, title: "title0", content: "content0", isApp: true, createdTime: "2021-04-12 15:52:??", position: 1024))
